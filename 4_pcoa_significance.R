## Significance of individual loadings and principal components

library(stringr)

# Permutation folder
path <- "/path/pcoa/permutations"
...
write.csv(p_component,"/path/pcoa/pcoa_components_pval.csv")
write.csv(p_loadings,"/path/pcoa/pcoa_loadings_pval.csv")
write.csv(sign001_loadings,"/path/pcoa/pcoa_loadings_pval_sign001.csv")
write.csv(signbonf_loadings,"/path/pcoa/pcoa_loadings_pval_signbonf.csv")

##---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## Significance of average loadings within each hierarchical cluster
library(lessR)
...
#Save for later use 
write.csv(p_cluster,"/path/pcoa/pcoa_cluster_loadings_pval.csv")
write.csv(sign001_clusters,"/path/pcoa/pcoa_cluster_loadings_pval_sing001.csv")
write.csv(signbonf_clusters,"/path/pcoa/pcoa_cluster_loadings_pval_signbonf.csv")